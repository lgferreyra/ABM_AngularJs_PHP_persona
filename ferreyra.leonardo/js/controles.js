...
app.controller("controlPersonaAlta", function($scope, FileUploader, $auth, $state, $http){
  ...
  $scope.uploader.queueLimit = 1; // indico cuantos archivos permito cargar
    ...
    $scope.Guardar = function() {
      $http.post('PHP/nexo.php', {datos: {accion:"votar", voto: $scope.persona}})
...
app.controller("controlPersonaGrillaUser", function($scope, $http, $auth, $state){
    
    $scope.ListadoUsuarios = {};
  
  $http.get('PHP/nexo.php', { params: {accion :"traerUsers"}})
  .then(function(respuesta) {       
